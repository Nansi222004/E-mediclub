      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-teal-dark to-teal p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-md">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/20 mb-8 backdrop-blur-md">
            <span>👨‍⚕️</span>
            <span className="text-sm font-semibold tracking-wide">Clinical Partner Portal</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full vendor-auth-card shadow-2xl border border-slate-100 bg-white relative">
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-teal-dark to-teal rounded-2xl flex items-center justify-center text-2xl shadow-lg mb-4">
              <span className="text-white">👨‍⚕️</span>
            </div>
            <h2 className="text-2xl font-extrabold text-slate-800 font-['Plus_Jakarta_Sans']">Emediclub</h2>
            <p className="text-sm font-bold text-teal mt-1">👨‍⚕️ Clinical Partner Portal</p>
          </div>

          <div className="mb-8">
            <h3 className="text-2xl font-black text-slate-800 tracking-tight">Welcome back</h3>
            <p className="text-sm text-slate-500 font-medium mt-2">Sign in to manage your practice</p>
          </div>
