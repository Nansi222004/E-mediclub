      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-[#082f49] to-teal p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-md">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/20 mb-8 backdrop-blur-md">
            <span>🔬</span>
            <span className="text-sm font-semibold tracking-wide">Diagnostics Partner Network</span>
          </div>
          <p className="text-white/80 text-lg leading-relaxed">
            Grow your diagnostic center. Receive online test bookings, manage home collections, and deliver digital reports instantly.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col p-4 sm:p-8 overflow-y-auto">
        <div className="w-full max-w-xl mx-auto flex-1 flex flex-col pt-8">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-12 h-12 bg-gradient-to-br from-[#082f49] to-teal rounded-xl flex items-center justify-center text-xl shadow-lg">
              <span className="text-white">🔬</span>
            </div>
            <div>
              <h2 className="text-xl font-extrabold text-slate-800 font-['Plus_Jakarta_Sans']">Emediclub</h2>
              <p className="text-xs font-bold text-teal">Diagnostics Partner Portal</p>
            </div>
          </div>
